...
/*** theme ***/
@theme                 : table-sorter-ads-com;

/*** fonts ***/
@tableHeaderFont       : 14px @font-family-sans-serif; 
@tableBodyFont         : 13px @font-family-sans-serif;

/*** color definitions ***/
/* for best results, only change the hue (120),
   leave the saturation (60%) and luminosity (75%) alone
   pick the color from here: http://hslpicker.com/#99E699 */
@headerBackground      : @brand-secondary;
@borderAndBackground   : @gray-lighter;
...
@headerAsc             : @brand-warning; /* darken(@headerBackground, 10%); */
@headerDesc            : @brand-warning; /* desaturate(@headerAsc, 5%); */
...
@filterElementBorder   : 1px solid @gray-lighter;
@filterTransitionTime  : 0.25s;
